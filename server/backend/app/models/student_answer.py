...
class StudentAnswer(BaseModel):
    ...
    # Constraints
    __table_args__ = (
        UniqueConstraint("student_exam_id", "question_id", name="uq_student_exam_question_answer"),
    ...
    # Relationships
    student_exam: Mapped["StudentExam"] = relationship("StudentExam", back_populates="answers")

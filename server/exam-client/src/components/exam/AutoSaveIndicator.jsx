...
export const AutoSaveIndicator = ({
  ...
  const configs = {
    [SYNC_STATUS.IDLE]: {
      ...
      icon: <CheckCircle2 className="w-3.5 h-3.5 text-text-muted shrink-0" aria-hidden="true" />,
  ...
  return (
    ...
    >
      <span aria-hidden="true" className="shrink-0 flex items-center justify-center">{config.icon}</span>
